# 📈 Black-Scholes Simulation Suite

> A comprehensive, menu-driven Black-Scholes option pricing simulator written in Java — featuring analytic pricing, Monte Carlo simulation, implied volatility solving, Greeks computation, and batch CSV processing, all from an interactive command-line interface.
...
| Feature | Description |
|---|---|
| **Analytic Pricing** | Closed-form pricing for European calls/puts, binary calls, and digital puts |
